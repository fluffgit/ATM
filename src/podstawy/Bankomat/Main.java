...
public class Main {
    public static void main(String[] args) {
        ...
        Client clientForService = bankomat.putCard("124");
                ...
                switch (choice) {
                    ...
                    case "2":
                        ...
                        if (scanner2.hasNextLine()) {
                            ...
                            if (bankomat.isWithdrawPossible(clientForService, Double.parseDouble(amt))) {
                                ...
                                System.out.printf("Kwota wypłacona: %s, Stan konta: %.2f\n", amt, bankomat.checkBalance(clientForService));
                            } else {
                                System.out.printf("Nie można wyplacić kwoty: %.2s\n", amt);
                                System.out.printf("Stan konta: %.2f\n", bankomat.checkBalance(clientForService));
                            }
                        }
                        break;
                    ...
                    case "4":
                        ...
                        if (bankomat.isWithdrawPossible(clientForService, Double.parseDouble(amt2))) {
                            ...
                            System.out.printf("Nie można wyplacić kwoty: %s\n", amt2);
                            System.out.printf("Stan konta: %.2f\n", bankomat.checkBalance(clientForService));
                        }
